...
function mountClassInstance(
  ...
  // 执行getDerivedStateFromProps方法，该方法在state改变之前触发，他的返回值会作为新的state合并
  ...
  if (
    ...
    // 如果没有getDerivedStateFromProps和getSnapshotBeforeUpdate方法时，执行componentWillMount
